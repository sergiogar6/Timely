...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => BusinessWidget(
            business: params.getParam(
              ...
              isList: false,
              structBuilder: BusinessStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ConfirmedAppointmentWidget.routeName,
          path: ConfirmedAppointmentWidget.routePath,
          builder: (context, params) => ConfirmedAppointmentWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TimelySelectorWidget.routeName,
          path: TimelySelectorWidget.routePath,
          builder: (context, params) => TimelySelectorWidget(),
        ),
        FFRoute(
          name: AppointmentsBusinessWidget.routeName,
          path: AppointmentsBusinessWidget.routePath,
          builder: (context, params) => AppointmentsBusinessWidget(),
        ),
        FFRoute(
