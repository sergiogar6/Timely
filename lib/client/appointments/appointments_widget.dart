...
class _AppointmentsWidgetState extends State<AppointmentsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.appointmentsOutput = await actions.getAppointments(
        FFAppState().currentUser.id,
      );
      _model.appointments = _model.appointmentsOutput!
          .map((e) => AppointmentStruct.maybeFromMap(e))
          .withoutNulls
          .toList()
          .toList()
          .cast<AppointmentStruct>();
      safeSetState(() {});
    });
  }
